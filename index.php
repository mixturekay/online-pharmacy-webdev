    ...
    <section id="banner-area">
      <div class="owl-carousel owl-theme">
        <div class="item">
          ...
          <h1>Welcome To Mixture's Online Pharmacy</h1>
          <p>we humbly welcome you to our trusted and fast delivery website</p>
        ...
        <div class="item">
          ...
          <img src="assets/img/banner/banner8.jpg">
        </div>
        <div class="item">
          <div class="slide-content">
          <h1>Welcome To Mixture's Online Pharmacy</h1>
 	...
 	<!-- owl-carousel-->
        ...
        <!---product section ------->
        <?php 
        //include the recent post section
